...
const Header = ({handleToggleSidebar}) => {
    ...
    return (
        <div className="border border-dark header">
            ...
            <form onSubmit={handleSubmit}><input type="text" placeholder="Search" value={input} onChange={e=>setInput(e.target.value)}/><button type="submit"><AiOutlineSearch size={22}/></button></form>
